...
func NewRefundPolicy(bot ports.Bot) ports.CommandHandler {
	return &RefundPolicy{bot}
}

func (uc *RefundPolicy) Execute(ctx context.Context, msg input.Message, user domain.User) error {
	text := i18n.Get(user.LanguageCode, "RefundPolicy", nil, nil)
...
func (uc *RefundPolicy) buildReplyMarkup(languageCode string) interaction.InlineKeyboardMarkup {
